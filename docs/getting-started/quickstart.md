...
Get up and running with OpenEyes in 5 minutes.
...
!!! tip
    See [Performance Guide](#) for more performance tuning options.
...
- Read [Installation Guide](installation.md) for detailed installation
- Read [User Guide](../user-guide/commands.md) for usage guide
- Check [Technical Specs](../reference/technical-spec.md) for technical details